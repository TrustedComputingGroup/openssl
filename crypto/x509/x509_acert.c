...
ASN1_SEQUENCE_cb(X509_ACERT_INFO, NULL) = {
...
} ASN1_SEQUENCE_END_cb(X509_ACERT_INFO, X509_ACERT_INFO)

ASN1_SEQUENCE_cb(X509_ACERT, NULL) = {
...
} ASN1_SEQUENCE_END_cb(X509_ACERT, X509_ACERT)
